...
class SensitiveSanityCheck(unittest.TestCase):
    ...
    def test_sanity(self):
        ...
        # self.G.add_edge(0, 2, capacity = 11)
        ...
        # self.G.add_edge(4, 5, capacity = 30)
        self.G.add_edge(0, 1, capacity = 2)
        self.G.add_edge(1, 2, capacity=1)
        self.G.add_edge(0, 3, capacity=1)
        self.G.add_edge(3, 4, capacity=1)
        self.G.add_edge(1, 4, capacity=1)
        self.G.add_edge(3, 2, capacity=1)
        self.G.add_edge(2, 5, capacity=1)
        self.G.add_edge(4, 5, capacity=2)
